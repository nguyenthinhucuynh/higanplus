...
def apply_vertical_stripe_mask(imgs, img_lens, mask_ratio_range=(0.1, 0.2), stripe_width_range=(2, 5)):
    """
...
def apply_horizontal_stripe_mask(imgs, img_lens, mask_ratio_range=(0.1, 0.2), stripe_height_range=(2, 5)):
    """
...
def apply_combined_stripe_mask(imgs, img_lens, mask_ratio_range=(0.1, 0.2),
                                stripe_width_range=(2, 5), stripe_height_range=(2, 5)):
    """
